...
const AES_OUT_AUTH_TAG_SIZE: usize = crypto_aead_aes256gcm_ABYTES as usize;

pub const fn get_aes256gcm_ciphertext_len(plaintext_len: usize)
    -> usize {
    return plaintext_len + AES_OUT_AUTH_TAG_SIZE
}

pub const fn get_aes256gcm_plaintext_len(ciphertext_len: usize)
    -> usize {
    return ciphertext_len - AES_OUT_AUTH_TAG_SIZE;
}
...
// }
//
// pub fn aes256_decrypt_afterenm(key: &AesKey, nonce: &AesNonce, ciphertext: &[u8])
//   -> SodiumBox<u8> {
//     let mut actual_plaintext_len: c_ulonglong = 0;
