...
use crate::sodium_bindings::{crypto_generichash_blake2b_final, crypto_generichash_blake2b_init, crypto_generichash_blake2b_state, crypto_generichash_blake2b_update, crypto_hash_sha256_final, crypto_hash_sha256_init, crypto_hash_sha256_state, crypto_hash_sha256_update, sodium_memzero};
...
impl Sha256 {
    ...
    pub fn update(&mut self, data: &[u8]) {
        unsafe {
            crypto_hash_sha256_update(self.inner.as_mut_ptr(), data.as_ptr(), data.len() as c_ulonglong);
        }
    }
    pub fn update_from_ptr(&mut self, data: *const u8, len: usize) {
        unsafe {
